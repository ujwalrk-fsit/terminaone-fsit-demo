...
export const funds: FundOffering[] = [
  { _id: 'f_alpha_1', fundName: 'Alpha Private Growth I', fundType: 'private_equity', targetIrr: 18, minimumInvestment: 25000, offerPricePerUnit: 100, offeringSize: 50000000, nav: 52.4, returnPercentage: 12.6, sector: 'Enterprise Software', subSector: 'Data Intelligence', headquarters: 'Mumbai', foundedOn: '2021', subscriptionStart: '2026-06-01', subscriptionEnd: '2026-12-31', status: 'live', managers: ['u_fm'], affiliates: ['u_aff'], faqs: [{ q: 'Who can invest?', a: 'Accredited investors (mock).' }], keyRisks: 'Private markets are illiquid (mock).', bankDetails: { bankName: 'HDFC Bank', accountName: 'TSG Alpha Escrow', accountNumber: '50200012345678', routingCode: 'HDFC0001234', swift: 'HDFCINBB', branch: 'Mumbai BKC', instructions: 'Transfer exact indication amount with reference ID. Upload proof to move to review.', uploadedBy: 'u_fm', updatedAt: '2026-09-01' }, opportunityId: 'o_anthropic' },
  { _id: 'f_alpha_2', fundName: 'Alpha AI & Defense II', fundType: 'equity', targetIrr: 22, minimumInvestment: 50000, offerPricePerUnit: 250, offeringSize: 75000000, nav: 78.1, returnPercentage: 18.2, sector: 'Industrial', subSector: 'Aerospace & Defense', headquarters: 'Bengaluru', foundedOn: '2022', status: 'live', managers: ['u_fm'], affiliates: [], faqs: [], keyRisks: 'Concentration risk (mock).', bankDetails: { bankName: 'ICICI Bank', accountName: 'TSG Defense Escrow', accountNumber: '004405012345', routingCode: 'ICIC0000044', instructions: 'Use indication reference in remarks.', uploadedBy: 'u_admin', updatedAt: '2026-08-20' }, opportunityId: 'o_anduril' },
  { _id: 'f_income_1', fundName: 'Stable Income Notes', fundType: 'debt', minimumInvestment: 10000, offerPricePerUnit: 50, offeringSize: 20000000, sector: 'Fintech', subSector: 'Payments', status: 'live', managers: ['u_fm'], affiliates: ['u_aff'], faqs: [], keyRisks: 'Credit risk (mock).' },
  { _id: 'f_growth_1', fundName: 'SaaS Growth SPV', fundType: 'equity', minimumInvestment: 15000, offerPricePerUnit: 75, offeringSize: 15000000, sector: 'Enterprise Software', subSector: 'Cloud/Networking Infrastructure', status: 'upcoming', managers: ['u_fm'], affiliates: [], faqs: [], keyRisks: 'Mock.' },
  { _id: 'f_re_1', fundName: 'Logistics Parks RE', fundType: 'real_estate', minimumInvestment: 50000, offerPricePerUnit: 200, offeringSize: 40000000, sector: 'Industrial', subSector: 'Robotics', status: 'upcoming', managers: ['u_fm'], affiliates: [], faqs: [], keyRisks: 'Mock.' },
  { _id: 'f_alpha_0', fundName: 'Alpha Pilot (Closed)', fundType: 'private_equity', minimumInvestment: 25000, offerPricePerUnit: 100, offeringSize: 10000000, sector: 'Healthcare', subSector: 'Medical Devices', status: 'closed', managers: ['u_fm'], affiliates: [], faqs: [], keyRisks: 'Mock.' },

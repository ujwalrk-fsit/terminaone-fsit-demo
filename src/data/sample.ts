...
export const users: AppUser[] = [
  { _id: 'u_admin', firstName: 'Asha', lastName: 'Admin', emailId: 'admin@terminaone.com', roleGroup: 'admin', roleId: 'r_admin', status: 'active', password: 'admin123' },
  { _id: 'u_adv', firstName: 'Ravi', lastName: 'Advisor', emailId: 'advisor@terminaone.com', roleGroup: 'advisor', roleId: 'r_advisor', status: 'active', password: 'advisor123' },
  { _id: 'u_aff', firstName: 'Mira', lastName: 'Affiliate', emailId: 'affiliate@terminaone.com', roleGroup: 'affiliate', roleId: 'r_affiliate', status: 'active', password: 'affiliate123' },
  { _id: 'u_fm', firstName: 'Karan', lastName: 'Manager', emailId: 'manager@terminaone.com', roleGroup: 'fund_manager', roleId: 'r_fm', status: 'active', password: 'manager123' },
  { _id: 'u_mon', firstName: 'Ira', lastName: 'Monitor', emailId: 'monitor@terminaone.com', roleGroup: 'monitor', roleId: 'r_monitor', status: 'active', password: 'monitor123' },
  { _id: 'u_inv1', firstName: 'Dev', lastName: 'Investor', emailId: 'investor@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Plus', password: 'investor123' },
  { _id: 'u_inv2', firstName: 'Nina', lastName: 'New', emailId: 'nina@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'pending', investorStatus: 'PENDING_ONBOARDING', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv3', firstName: 'Aarav', lastName: 'Mehta', emailId: 'aarav@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv4', firstName: 'Diya', lastName: 'Nair', emailId: 'diya@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv5', firstName: 'Kabir', lastName: 'Shah', emailId: 'kabir@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'pending', investorStatus: 'PENDING_ONBOARDING', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv6', firstName: 'Ananya', lastName: 'Iyer', emailId: 'ananya@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv7', firstName: 'Rohan', lastName: 'Verma', emailId: 'rohan@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv8', firstName: 'Ishita', lastName: 'Rao', emailId: 'ishita@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Plus', password: 'investor123' },
  { _id: 'u_inv9', firstName: 'Vikram', lastName: 'Menon', emailId: 'vikram@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'pending', investorStatus: 'PENDING_ONBOARDING', tier: 'Plus', password: 'investor123' },
  { _id: 'u_inv10', firstName: 'Sara', lastName: 'Khan', emailId: 'sara@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv11', firstName: 'Aditya', lastName: 'Rao', emailId: 'aditya@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Pro', password: 'investor123' },
  { _id: 'u_inv12', firstName: 'Neha', lastName: 'Gupta', emailId: 'neha@terminaone.com', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Pro', password: 'investor123' },
];
...
export const accounts: InvestorAccount[] = [
  ...
  { _id: 'a_inv3', userId: 'u_inv3', accountType: 'INDIVIDUAL', status: 'ACTIVE', stepKey: 'DONE', kycName: 'Aarav Mehta' },
  { _id: 'a_inv4', userId: 'u_inv4', accountType: 'JOINT', status: 'ACTIVE', stepKey: 'DONE', kycName: 'Diya Nair' },
  { _id: 'a_inv5', userId: 'u_inv5', accountType: 'INDIVIDUAL', status: 'DRAFT', stepKey: 'ADDRESS' },
  { _id: 'a_inv6', userId: 'u_inv6', accountType: 'INDIVIDUAL', status: 'ACTIVE', stepKey: 'DONE', kycName: 'Ananya Iyer' },
  { _id: 'a_inv7', userId: 'u_inv7', accountType: 'LLC', status: 'ACTIVE', stepKey: 'DONE', kycName: 'Rohan Verma' },
  { _id: 'a_inv8', userId: 'u_inv8', accountType: 'INDIVIDUAL', status: 'ACTIVE', stepKey: 'DONE', kycName: 'Ishita Rao' },
  { _id: 'a_inv9', userId: 'u_inv9', accountType: 'INDIVIDUAL', status: 'IN_REVIEW', stepKey: 'DONE' },
  { _id: 'a_inv10', userId: 'u_inv10', accountType: 'INDIVIDUAL', status: 'ACTIVE', stepKey: 'DONE', kycName: 'Sara Khan' },
  { _id: 'a_inv11', userId: 'u_inv11', accountType: 'TRUST', status: 'ACTIVE', stepKey: 'DONE', kycName: 'Aditya Rao' },
  { _id: 'a_inv12', userId: 'u_inv12', accountType: 'INDIVIDUAL', status: 'ACTIVE', stepKey: 'DONE', kycName: 'Neha Gupta' },
];
...
export const indications: Indication[] = [
  ...
  { _id: 'i_11', investorUserId: 'u_inv3', investorAccountId: 'a_inv3', fundId: 'f_alpha_1', opportunityId: 'o_anthropic', numberOfUnits: 250, investmentAmount: 25000, status: 'APPROVED', createdAt: '2026-08-12', updatedAt: '2026-09-01' },
  { _id: 'i_12', investorUserId: 'u_inv4', investorAccountId: 'a_inv4', fundId: 'f_income_1', opportunityId: 'o_stripe', numberOfUnits: 400, investmentAmount: 20000, status: 'ALLOCATED', createdAt: '2026-07-15', updatedAt: '2026-08-20' },
  { _id: 'i_13', investorUserId: 'u_inv6', investorAccountId: 'a_inv6', fundId: 'f_alpha_2', opportunityId: 'o_anduril', numberOfUnits: 80, investmentAmount: 20000, status: 'SUBSCRIBED', createdAt: '2026-09-03', updatedAt: '2026-09-03' },
  { _id: 'i_14', investorUserId: 'u_inv7', investorAccountId: 'a_inv7', fundId: 'f_growth_1', opportunityId: 'o_figma', numberOfUnits: 200, investmentAmount: 15000, status: 'AWAITING_APPROVAL', createdAt: '2026-09-07', updatedAt: '2026-09-07' },
  { _id: 'i_15', investorUserId: 'u_inv8', investorAccountId: 'a_inv8', fundId: 'f_alpha_1', opportunityId: 'o_anthropic', numberOfUnits: 500, investmentAmount: 50000, status: 'AWAITING_SIGNATURE', createdAt: '2026-09-05', updatedAt: '2026-09-06' },
  { _id: 'i_16', investorUserId: 'u_inv10', investorAccountId: 'a_inv10', fundId: 'f_income_1', opportunityId: 'o_stripe', numberOfUnits: 100, investmentAmount: 5000, status: 'PAYMENT_PROCESSING', createdAt: '2026-09-11', updatedAt: '2026-09-11' },
  { _id: 'i_17', investorUserId: 'u_inv11', investorAccountId: 'a_inv11', fundId: 'f_alpha_2', opportunityId: 'o_openai', numberOfUnits: 200, investmentAmount: 50000, status: 'APPROVED', createdAt: '2026-08-25', updatedAt: '2026-09-02' },
  { _id: 'i_18', investorUserId: 'u_inv12', investorAccountId: 'a_inv12', fundId: 'f_alpha_2', opportunityId: 'o_anduril', numberOfUnits: 160, investmentAmount: 40000, status: 'ALLOCATED', createdAt: '2026-07-20', updatedAt: '2026-08-15' },
  { _id: 'i_19', investorUserId: 'u_inv3', investorAccountId: 'a_inv3', fundId: 'f_income_1', numberOfUnits: 300, investmentAmount: 15000, status: 'DRAFT', createdAt: '2026-09-12', updatedAt: '2026-09-12' },
  { _id: 'i_20', investorUserId: 'u_inv4', investorAccountId: 'a_inv4', fundId: 'f_alpha_1', opportunityId: 'o_databricks', numberOfUnits: 150, investmentAmount: 15000, status: 'REJECTED', createdAt: '2026-06-10', updatedAt: '2026-06-25' },
  { _id: 'i_21', investorUserId: 'u_inv8', investorAccountId: 'a_inv8', fundId: 'f_alpha_2', opportunityId: 'o_coreweave', numberOfUnits: 120, investmentAmount: 30000, status: 'AWAITING_APPROVAL', createdAt: '2026-09-09', updatedAt: '2026-09-09' },
  { _id: 'i_22', investorUserId: 'u_inv11', investorAccountId: 'a_inv11', fundId: 'f_alpha_1', numberOfUnits: 1000, investmentAmount: 100000, status: 'PAYMENT_PROCESSING', createdAt: '2026-09-12', updatedAt: '2026-09-12' },
  { _id: 'i_23', investorUserId: 'u_inv6', investorAccountId: 'a_inv6', fundId: 'f_income_1', opportunityId: 'o_stripe', numberOfUnits: 120, investmentAmount: 6000, status: 'SUBSCRIBED', createdAt: '2026-09-06', updatedAt: '2026-09-06' },
  { _id: 'i_24', investorUserId: 'u_inv12', investorAccountId: 'a_inv12', fundId: 'f_growth_1', opportunityId: 'o_figma', numberOfUnits: 400, investmentAmount: 30000, status: 'DRAFT', createdAt: '2026-09-12', updatedAt: '2026-09-12' },
];
...
export const transfers: Transfer[] = [
  ...
  { _id: 't_3', indicationId: 'i_12', investorUserId: 'u_inv4', totalAmount: 20000, currency: 'INR', status: 'SUCCEEDED', method: 'BANK_TRANSFER', reference: 'REF-I12-20000', createdAt: '2026-08-20' },
  { _id: 't_4', indicationId: 'i_18', investorUserId: 'u_inv12', totalAmount: 40000, currency: 'INR', status: 'SUCCEEDED', method: 'BANK_TRANSFER', reference: 'REF-I18-40000', createdAt: '2026-08-15' },
  { _id: 't_5', indicationId: 'i_11', investorUserId: 'u_inv3', totalAmount: 25000, currency: 'INR', status: 'PROCESSING', method: 'BANK_TRANSFER', reference: 'REF-I11-25000', createdAt: '2026-09-01' },
  { _id: 't_6', indicationId: 'i_22', investorUserId: 'u_inv11', totalAmount: 100000, currency: 'INR', status: 'PROCESSING', method: 'BANK_TRANSFER', reference: 'REF-I22-100000', createdAt: '2026-09-12' },
  { _id: 't_7', indicationId: 'i_16', investorUserId: 'u_inv10', totalAmount: 5000, currency: 'INR', status: 'FAILED', method: 'BANK_TRANSFER', reference: 'REF-I16-5000', createdAt: '2026-09-11' },
  { _id: 't_8', indicationId: 'i_17', investorUserId: 'u_inv11', totalAmount: 50000, currency: 'INR', status: 'SUCCEEDED', method: 'BANK_TRANSFER', reference: 'REF-I17-50000', createdAt: '2026-09-02' },
];

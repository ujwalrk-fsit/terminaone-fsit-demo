...
export const users: AppUser[] = [
  ...
  { _id: 'u_inv1', firstName: 'Dev', lastName: 'Investor', emailId: 'investor@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Plus', password: 'investor123' },
  { _id: 'u_inv2', firstName: 'Nina', lastName: 'New', emailId: 'nina@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'pending', investorStatus: 'PENDING_ONBOARDING', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv3', firstName: 'Aarav', lastName: 'Mehta', emailId: 'aarav@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv4', firstName: 'Diya', lastName: 'Nair', emailId: 'diya@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv5', firstName: 'Kabir', lastName: 'Shah', emailId: 'kabir@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'pending', investorStatus: 'PENDING_ONBOARDING', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv6', firstName: 'Ananya', lastName: 'Iyer', emailId: 'ananya@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv7', firstName: 'Rohan', lastName: 'Verma', emailId: 'rohan@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv8', firstName: 'Ishita', lastName: 'Rao', emailId: 'ishita@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Plus', password: 'investor123' },
  { _id: 'u_inv9', firstName: 'Vikram', lastName: 'Menon', emailId: 'vikram@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'pending', investorStatus: 'PENDING_ONBOARDING', tier: 'Plus', password: 'investor123' },
  { _id: 'u_inv10', firstName: 'Sara', lastName: 'Khan', emailId: 'sara@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Lite', password: 'investor123' },
  { _id: 'u_inv11', firstName: 'Aditya', lastName: 'Rao', emailId: 'aditya@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Pro', password: 'investor123' },
  { _id: 'u_inv12', firstName: 'Neha', lastName: 'Gupta', emailId: 'neha@demo.local', roleGroup: 'investor', roleId: 'r_investor', status: 'active', investorStatus: 'ONBOARDED', tier: 'Pro', password: 'investor123' },
];
